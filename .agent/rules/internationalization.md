...
## Context
AulaCheck es una aplicación multiidioma que soporta **Español (es)**, **Inglés (en)** y **Portugués (pt)**. Es crítico que ningún texto visible para el usuario esté escrito directamente en el código de los componentes.
