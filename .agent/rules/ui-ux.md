...
## Context
AulaCheck utiliza un sistema de temas dual. El código debe ser capaz de adaptarse dinámicamente a la preferencia del usuario o del sistema, manteniendo una legibilidad óptima en ambos estados.
...
- **Color Inversion Avoidance**: No inviertas colores de fotos; solo ajusta bordes, sombras y contenedores.
